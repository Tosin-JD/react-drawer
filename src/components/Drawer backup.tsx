...
const Drawer: React.FC<DrawerProps> = ({ 
    ...
    const positionClasses: Record<DrawerPosition, string> = {
        ...
        'top': 'inset-x-0 top-0 translate-y-full',
    ...
    return (
        <>
            ...
            <div
                className={`fixed transform px-2 mx-2 backdrop-blur-sm border border-gray/20 bg-opacity-75
            ...
            >
                <div onClick={onClose} className='p-6'>
                    <div className={`flex ${isVertical ? 'justify-center': 'items-center h-full'}`}>
